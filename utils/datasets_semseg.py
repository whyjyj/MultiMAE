...
def simple_transform(train: bool,
    ...
    if train:
        transform = A.Compose([
            ...
            A.CoarseDropout(
                            max_holes=20, max_height=input_size//8, max_width=input_size//8,
                            min_holes=15, min_height=input_size//16, min_width=input_size//16,
                            fill_value=pad_value, mask_fill_value=pad_mask_value, p=1),
